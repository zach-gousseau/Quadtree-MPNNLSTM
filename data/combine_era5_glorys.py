...
if __name__ == '__main__':
    ...
    era5 = xr.open_mfdataset(glob.glob("/path/to/*.nc"))
    ...
    era5 = era5.sel(latitude=slice(*lats), longitude=slice(*lons))
    ...
    for year in tqdm.tqdm(range(years[0], years[1]+1)):
        ...
        ds_y.to_netcdf(f'/home/zgoussea/scratch/hb_era5_glorys_nc/hb_era5_glorys_{year}.nc')
